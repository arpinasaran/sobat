...
urlpatterns = [
    ...
    path('add_question_flutter/<str:id>/', add_question_flutter, name='add_question_flutter'),
    ...
    path('delete_question_flutter/<str:id>/', delete_question_flutter, name='delete_question_flutter'),
    path('delete_answer/<str:id>/', delete_answer, name='delete_answer'),
    path('delete_answer_flutter/<str:id>/', delete_answer_flutter, name='delete_answer_flutter'),
    path('answer_question/<str:questionId>/<str:productId>/', answer_question, name='answer_question'),
    path('answer_question_flutter/<str:questionId>/<str:productId>/', answer_question_flutter, name='answer_question_flutter'),
